...
#define THRESHOLD_SUPPRESS 2
    ...
    bool json_content_not[MAX_META_CONTENT];
    char json_content_key[MAX_META_CONTENT][128];
    char json_content_content[MAX_META_CONTENT][1024];
    int  json_content_count;
    bool json_content_case[MAX_META_CONTENT];
