            ...
            if (config->bluedot_flag)
                {
                    ...
                    Sagan_Log(NORMAL, "");
                    Sagan_Log(NORMAL, "          Hashes in cache               : %" PRIu64 " (Cache used: %.3f%%)", counters->bluedot_hash_cache_count, CalcPct(counters->bluedot_hash_cache_count, config->bluedot_max_cache));
                    ...
                    Sagan_Log(NORMAL, "");
                    Sagan_Log(NORMAL, "          URLs in cache                 : %" PRIu64 " (Cache used: %.3f%%)", counters->bluedot_url_cache_count, CalcPct(counters->bluedot_url_cache_count, config->bluedot_max_cache));
                    ...
                    Sagan_Log(NORMAL, "");
                    Sagan_Log(NORMAL, "          Filenames in cache            : %" PRIu64 " (Cache used: %.3f%%)", counters->bluedot_filename_cache_count, CalcPct(counters->bluedot_filename_cache_count, config->bluedot_max_cache));
